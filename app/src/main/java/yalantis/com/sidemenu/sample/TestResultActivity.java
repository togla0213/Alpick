...
public class TestResultActivity extends AppCompatActivity implements ViewAnimator.ViewAnimatorListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportFragmentManager().beginTransaction()
                .replace(R.id.test_result_frame, contentFragment)
                .commit();
        drawerLayout = (DrawerLayout) findViewById(R.id.test_result_drawer_layout);
        drawerLayout.setScrimColor(Color.TRANSPARENT);
        linearLayout = (LinearLayout) findViewById(R.id.test_result_left_drawer);
    ...
    private ScreenShotable replaceFragment(ScreenShotable screenShotable, int topPosition) {
        ...
        View view = findViewById(R.id.test_result_frame);
        ...
        getSupportFragmentManager().beginTransaction().replace(R.id.test_result_frame, contentFragment).commit();
