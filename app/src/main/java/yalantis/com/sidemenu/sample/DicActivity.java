...
public class DicActivity extends AppCompatActivity implements ViewAnimator.ViewAnimatorListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportFragmentManager().beginTransaction()
                ...
                .commit();
        drawerLayout = (DrawerLayout) findViewById(R.id.dic_drawer_layout);
        drawerLayout.setScrimColor(Color.TRANSPARENT);
        linearLayout = (LinearLayout) findViewById(R.id.dic_left_drawer);
    ...
    private void setActionBar() {
        Toolbar toolbar = (Toolbar) findViewById(R.id.dic_toolbar);
    ...
    private ScreenShotable replaceFragment(ScreenShotable screenShotable, int topPosition) {
        ...
        View view = findViewById(R.id.dic_frame);
    ...
    private ScreenShotable replaceDic(ScreenShotable screenShotable, int topPosition) {
        Intent it_main = new Intent(DicActivity.this, DicActivity.class);
        startActivity(it_main);
